...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "cubiks-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/framlings-playground"
  #   chef.validation_client_name = "framlings-playground-validator"
  #   chef.validation_key_path = ".chef/framlings-playground-validator.pem"
  # end
end
